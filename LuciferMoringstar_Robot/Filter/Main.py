...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if (clicked == typed):
        ...
        if query.data.startswith("next"):
            ...
            buttons = [
                [
                    InlineKeyboardButton('creator', url='t.me/thomas_shelby_jr'),
                    InlineKeyboardButton('Source Code', url='t.me/nokkiyirunno_ippo_kittum')
                ]
                ]
            ...
            buttons = [
                [
                    InlineKeyboardButton('Update Channel', url='t.me/thomas_shelby_jr'),
                    InlineKeyboardButton('Source Code', url='t.me/nokkiyirunno_ippo_kittum')
                ]
                ]
